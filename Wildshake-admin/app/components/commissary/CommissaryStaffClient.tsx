...
export interface CommissaryStaffMember {
  id: string
  name: string
  email: string | null
  is_active: boolean
...
interface Props {
  staff: CommissaryStaffMember[]
}

export default function CommissaryStaffClient({ staff: initialStaff }: Props) {
  const [staff, setStaff] = useState(initialStaff)
  const [showAddModal, setShowAddModal] = useState(false)
  const [editTarget, setEditTarget] = useState<CommissaryStaffMember | null>(null)
  ...
  async function handleAddStaff(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      setStaff(prev => [...prev, res.staff as CommissaryStaffMember])
  ...
  async function handleToggleActive(member: CommissaryStaffMember) {
    startTransition(async () => {
  ...
  function openEditModal(member: CommissaryStaffMember) {
